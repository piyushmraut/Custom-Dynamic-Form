...
//       <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 lg:p-8 border-2 border-dotted border-red-300">
//         {/* Header */}
...
//             <div className="col-span-1 bg-gray-50 p-4 rounded-lg border-2 border-dotted border-violet-500 ">
//               <h3 className="text-lg font-medium mb-4">Field Types</h3>
//               <FieldType onAddField={handleAddField} />
//             </div>
//             <div className="col-span-1 sm:col-span-1 lg:col-span-3">
//               <h3 className="text-xl font-medium mb-4 text-violet-600">Form Structure</h3>
//               <DragDropContext onDragEnd={handleDragEnd}>
//                 <Droppable droppableId="form-fields">
//                   {(provided) => (
//                     <div
//                       {...provided.droppableProps}
//                       ref={provided.innerRef}
//                       className="bg-gray-50 p-4 rounded-lg min-h-[400px] border-dotted border-2 border-red-400"
//                     >
//                       <FieldList
//                         fields={currentForm.fields}
//                         onRemoveField={handleRemoveField}
...
//                       {...provided.droppableProps}
//                       ref={provided.innerRef}
//                       className="bg-gray-50 p-4 rounded-lg h-[600px] overflow-y-auto border-dotted border-2 border-red-400"
//                     >
//                       <FieldList
//                         fields={currentForm.fields}
//                         onRemoveField={handleRemoveField}
                ...
                <Droppable droppableId="form-fields">
                  {(provided) => (
                    <div
                      {...provided.droppableProps}
                      ref={provided.innerRef}
                      className="bg-gray-50 p-4 rounded-lg h-[600px] overflow-y-auto border-dotted border-2 border-red-400 custom-scrollbar"
                    >
                      <FieldList
                        fields={currentForm.fields}
                        onRemoveField={handleRemoveField}
